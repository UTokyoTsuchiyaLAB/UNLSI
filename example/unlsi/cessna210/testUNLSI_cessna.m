...
wing = UNLSI(p',con',id',wedata,1,0.05); %コンストラクタの実行
...
set(gca,"FontSize",14);
plot(winddata.alpha,winddata.CL,'-o',"LineWidth",2);
plot(winddata.alpha,ad(:,5),'-o',"LineWidth",2);
plot(winddata.alpha,ad(:,6),'-o',"LineWidth",2);
...
set(gca,"FontSize",14);
plot(winddata.alpha,winddata.CD,'-o',"LineWidth",2);
plot(winddata.alpha,ad(:,9),'-o',"LineWidth",2);
plot(winddata.alpha,ad(:,11),'-o',"LineWidth",2);
legend("WT","Cp Integral","Trefftz")
xlabel("AoA deg");
ylabel("CD");
