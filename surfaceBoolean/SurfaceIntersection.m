...
% Moller's method begins by checking the mutual intersection of each
...
if n>0
  ...
  switch lower(algorithm)
    ...
    case 'rapid'
      ...
      % different results. Often faster than Moller.
...
if nnz(tMsk)>0
  ...
  [intMatrix(tMsk), intSurface2] = TriangleIntersection2D(V, U, N1(face1,:), getIntersection, debug);
